package com.kancy.delay.message.data.mongo.config;

import com.kancy.delay.message.data.mongo.repository.DelayMessageConfigRepository;
import com.kancy.delay.message.data.mongo.repository.DelayMessageRepository;
import com.kancy.delay.message.data.mongo.service.MongoDelayMessageConfigService;
import com.kancy.delay.message.data.mongo.service.MongoDelayMessageService;
